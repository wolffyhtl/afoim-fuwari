...
image: ../assets/images/2025-05-13-11-54-18-61f7cb01dbaf0cc0d9600129920d6666.webp
tags: [AI绘图, NoobAI]
category: '教程'
draft: false 
lang: ''
...
![2025-05-13-11-58-34-image.webp](../assets/images/2025-05-13-11-58-34-image.webp)
...
点击右下角的开始运行，先让他进行初始化，直到它自动打开你的浏览器并且可以正常进入Comfyui的界面，如下图![2025-05-13-12-06-57-image.webp](../assets/images/2025-05-13-12-06-57-image.webp)
...
最终工作流如图，然后点击执行队列！
![2025-05-13-12-24-12-image.webp](../assets/images/2025-05-13-12-24-12-image.webp)

然后你就能得到一张这样的图片：![2025-05-13-12-24-51-ComfyUI_00018_.webp](../assets/images/2025-05-13-12-24-51-ComfyUI_00018_.webp)

如果你想要图片是不同的样子请在正面提示词和反面提示词添加（**必须为英文！不知道的用翻译或者问AI！**）。比如我这边想要让足部放到焦点上并且裸足就添加**正面提示词**： `barefoot,feet in foreground`

![2025-05-13-12-27-07-ComfyUI_00019_.webp](../assets/images/2025-05-13-12-27-07-ComfyUI_00019_.webp)
...
- 参考：[NoobAI-XL (NAI-XL) - V-Pred-0.5-Version | NoobAI Checkpoint | Civitai](https://civitai.com/models/833294?modelVersionId=1046043)。关于更多的此模型的技巧可以到图片对应处的About查看![2025-05-13-12-30-55-image.webp](../assets/images/2025-05-13-12-30-55-image.webp)
