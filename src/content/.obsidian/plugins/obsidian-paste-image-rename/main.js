...
// src/batch.ts
const ImageBatchRenameModal = class extends import_obsidian.Modal {
...
const PasteImageRenamePlugin = class extends import_obsidian2.Plugin {
	constructor() {
		super(...arguments);
		this.modals = [];
	}
	...
	deduplicateNewName(newName, file) {
		return __async(this, null, function* () {
			...
			const newNameStem = newName.slice(
				0,
...
const ImageRenameModal = class extends import_obsidian2.Modal {
...
`;
const SettingTab = class extends import_obsidian2.PluginSettingTab {
